...
#!/usr/bin/env bash
bash <(curl -fsSL https://github.com/mi1314cat/sing-box-xary-hysteria2.catmi/raw/main/brutal-reality-hysteria.sh) \$1
EOF
...
# 作者介绍
print_with_delay "Brutal Vision Reality Hysteria2 三合一脚本 " 0.03
echo ""
echo ""
#install pkgs
install_pkgs
